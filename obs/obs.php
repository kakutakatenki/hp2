...
<!--form id="kenform"-->
<select name="kaind" id="datakaind" onchange="changeKaind()">
...
<script>
     ...
     var prec_no = "";
     var block_no = "";
     kaind = "<?php echo $kaind;?>";
     prec_no = "<?php echo $prec_no;?>";
     block_no = "<?php echo $block_no;?>";
     //データ種類からセレクト
     $("#datakaind option[value='"+kaind+"']").prop('selected', true);
     changeKaind();
    ...
    function sendform(){
     prec_no = document.getElementById("ken_selsect").value;
     block_no = document.getElementById("block_selsect").value;
     window.location.href = "obs.php?kaind="+kaind+"&prec_no="+prec_no+"&block_no="+block_no+"&year="+year +"&month="+month+"&day="+day;
    }
    function changeKaind(){
         kaind = document.getElementById("datakaind").value;
    }
    //changePlace("#block_selsect");
</script>
...
require("phpQuery-onefile.php");
     ...
     if(strlen($block_no)==5){
          ...
          //$url = "https://www.data.jma.go.jp/obd/stats/etrn/view/".$url_kaind."s1.php?prec_no=".$prec_no."&block_no=".$block_no."&year="
          ...
          //アメダスの場合
          //$url = "https://www.data.jma.go.jp/obd/stats/etrn/view/".$url_kaind."a1.php?prec_no=".$prec_no."&block_no=".$block_no."&year="
          //.$year_get."&month=".$month_get."&day=".$day_get."&view=";     
     }
          //アメダスの場合
          $url = "https://www.data.jma.go.jp/obd/stats/etrn/view/".$url_kaind.$point_type.".php?prec_no=".$prec_no."&block_no=".$block_no."&year="
          .$year_get."&month=".$month_get."&day=".$day_get."&view=";    
     ...
     //日ごと→時間ごと用
     $table= str_replace('hourly_s1.php?', './obs.php?kaind=hour&', $table);//URL置換　雷

     //月ごと→日ごと用
     $table= str_replace('daily_s1.php?', './obs.php?kaind=day&', $table);//URL置換　雷

     //年ごと→月ごと用
     $table= str_replace('monthly_s1.php?', './obs.php?kaind=month&', $table);//URL置換　雷


     echo "<table>".$table."</table>";
?>
<h2>他の県の過去の天気</h2>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=14&block_no=47412">札幌</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=31&block_no=47575">青森県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=32&block_no=47582">秋田県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=33&block_no=47584">岩手県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=34&block_no=47590">宮城県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=35&block_no=47588">山形県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=36&block_no=47595">福島県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=40&block_no=47629">茨城県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=41&block_no=47615">栃木県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=42&block_no=47624">群馬県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=43&block_no=47626">埼玉県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=44&block_no=47662">東京都</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=45&block_no=47682">千葉県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=46&block_no=47670">神奈川県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=48&block_no=47610">長野県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=49&block_no=47638">山梨県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=50&block_no=47656">静岡県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=51&block_no=47636">愛知県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=52&block_no=47632">岐阜県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=53&block_no=47651">三重県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=54&block_no=47604">新潟県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=55&block_no=47607">富山県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=56&block_no=47605">石川県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=57&block_no=47616">福井県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=60&block_no=47761">滋賀県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=61&block_no=47759">京都府</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=62&block_no=47772">大阪府</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=63&block_no=47769">兵庫県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=64&block_no=47780">奈良県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=65&block_no=47777">和歌山県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=66&block_no=47768">岡山県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=67&block_no=47766">広島県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=68&block_no=47741">島根県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=69&block_no=47746">鳥取県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=71&block_no=47895">徳島県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=72&block_no=47891">香川県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=73&block_no=47887">愛媛県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=74&block_no=47893">高知県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=81&block_no=47784">山口県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=82&block_no=47807">福岡県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=83&block_no=47815">大分県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=84&block_no=47817">長崎県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=85&block_no=47813">佐賀県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=86&block_no=47819">熊本県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=87&block_no=47830">宮崎県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=88&block_no=47827">鹿児島県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=91&block_no=47768">沖縄県</a>
<a href="./obs.php?kaind=<?php echo $kaind;?>&prec_no=99&block_no=89532">南極</a>
