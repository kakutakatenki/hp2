...
foreach($out_aera as $area){
     ...
     echo "<h3 class='aera_name'>".$area."</h3>";
     $i=0;//0：今日　1：明日 2:明後日
     ...
     foreach($out_fct[$area] as $ar_fct){
          ...
          if($i <=1){
               ...
               //echo  "<div class='fct'>".$ar_fct."</div>";//予報文(今日明日)
          }elseif($i==2){
               //明後日の場合
               echo  "<div class='fct'>".fcttoimg($ar_fct)."</div>";    
               //echo  "<div class='fct'>".$ar_fct."</div>";//予報文(今日明日)
          }
...
function fcttoimg($str){
     ...
     */
     $ret = "<span class='main_fct'>".$main_fct."</span><p class='text_min'>".$sub_fct."</p>";
